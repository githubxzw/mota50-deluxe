var maps_90f36752_8815_4be8_b32b_d7fad1d0542e = 
{
	...
	"2": {"cls":"animates","id":"fakeWall","canBreak":true,"trigger":"openDoor","animate":1,"doorInfo":{"time":200,"openSound":"开关门","closeSound":"开关门","keys":{}}},
	...
	"168": {"cls":"terrains","id":"flower","noPass":true,"canPass":true,"event":[{"type":"switch","condition":"core.status.floorId","caseList":[{"case":"'MT33'","action":[{"type":"if","condition":"(status:direction==='right')","true":[{"type":"moveHero","steps":["right:1"]}],"false":[{"type":"playSound","name":"开关门"},{"type":"hide","loc":[[8,10]],"remove":true,"destruct":true},{"type":"closeDoor","id":"yellowWall","loc":[8,10]}]}]},{"case":"'MT38'","action":[{"type":"if","condition":"(status:direction==='down')","true":[{"type":"moveHero","steps":["down:1"]}],"false":[{"type":"playSound","name":"开关门"},{"type":"hide","loc":[[2,5]],"remove":true,"destruct":true},{"type":"closeDoor","id":"yellowWall","loc":[2,5]}]}]}]}],"outEvent":[{"type":"hide","remove":true,"destruct":true},{"type":"closeDoor","id":"yellowWall"}]},
